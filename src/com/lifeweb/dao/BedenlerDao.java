...
public class BedenlerDao implements Serializable {
    ...
    public BedenlerDao(Integer bedenId) {
        this.bedenId = bedenId;
    }

    public BedenlerDao(Integer bedenId, String bedenKod) {
        this.bedenId = bedenId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BedenlerDao)) {
            return false;
        }
        BedenlerDao other = (BedenlerDao) object;
