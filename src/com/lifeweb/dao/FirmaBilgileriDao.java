...
public class FirmaBilgileriDao implements Serializable {
    ...
    public FirmaBilgileriDao() {
    }

    public FirmaBilgileriDao(String firmaAdi) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FirmaBilgileriDao)) {
            return false;
        }
        FirmaBilgileriDao other = (FirmaBilgileriDao) object;
