...
public class CariFisTurleriDao implements Serializable {
    ...
    public CariFisTurleriDao() {
    }

    public CariFisTurleriDao(Integer fturId) {
        this.fturId = fturId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CariFisTurleriDao)) {
            return false;
        }
        CariFisTurleriDao other = (CariFisTurleriDao) object;
