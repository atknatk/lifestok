...
public class GunlereGoreCiroPanel extends javax.swing.JFrame {

    private String ip;

    public GunlereGoreCiroPanel() {
        this.ip = null;
        initComponents();
    }

    public GunlereGoreCiroPanel(String ip) {
        this.ip = ip;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GunlereGoreCiro(dateChooserPanel2.getSelectedDate(),ip);
