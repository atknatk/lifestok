 ...
 * @author Atakan
 */
public class AylikKarPanel extends javax.swing.JFrame {

    String ip;

    public AylikKarPanel() {
        init();
           ip=null;
    }

    public AylikKarPanel(String ip) {
        init();
        this.ip = ip;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Date finish =getLastDay(start);
        ...
        if (ip == null) {
            new TarihlerArasiKar(start, finish);
        } else {
            new TarihlerArasiKar(ip, start,finish);
        }
