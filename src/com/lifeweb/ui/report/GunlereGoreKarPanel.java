 ...
 * @author Life
 */
public class GunlereGoreKarPanel extends javax.swing.JFrame {
    
    private String ip;
    public GunlereGoreKarPanel(String ip) {
        initComponents();
        this.ip=ip;
        
    }

      public GunlereGoreKarPanel() {
        initComponents();
        this.ip=null;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
              new GunlereGoreKar(dateChooserPanel2.getSelectedDate(),ip);
