 ...
 * @author Life
 */
public class CesitTanimlamaPanel extends javax.swing.JFrame {

    /**
     * Creates new form MarkaTanimlamaPanel
     */
    public CesitTanimlamaPanel() {
        initComponents();
...
//        jList1.setModel(model);
    ...
    private void jList1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jList1KeyReleased
        if (jList1.getSelectedIndex() != -1) {
            jTextField2.setText(((UrunCesit) jList1.getSelectedValue()).getCesitAdi());
        }
